...
def build_ori_anew_vectors(words):
    filename = './tmp/anew_vectors_retrofitted_word2vec.p'
...
if __name__ == '__main__':
    ...
    # check_same_words(words)
    # exit()
    remove_idx = []  # the indexes needed to be removed from vocabularies, as these are not occurring in the word2vec models
